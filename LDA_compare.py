...
file = open("sample_user.pickle","rb")
...
#result = pd.DataFrame()
result = pd.read_parquet('results/steam/all_algo_sample_user/recommendations.parquet')
#pf = ParquetFile('results/steam/all_algo_sample_user/recommendations.parquet')
...
RR_algo_comp.to_parquet('results/steam/all_algo_sample_user/RR_LDA1000.parquet')
#RR_algo_comp.to_csv("results/steam/pruned_5_new/RR_algo1000.csv", ignore_index=True)

pickle_out = open("results/steam/all_algo_sample_user/RR_LDA1000.pickle","wb")
pickle.dump(RR_algo_comp, pickle_out, protocol = 4)
pickle_out.close()


### join with algo name
legend = pd.read_csv("results/steam/all_algo_sample_user/runs.csv")
legend = legend.set_index('RunId').loc[:,'AlgoStr']

RR_algo = RR_algo_comp.join(legend, on='RunId')

RR_algo.to_parquet('results/steam/all_algo_sample_user/RR_algoname1000.parquet')
#RR_algo.to_csv("results/steam/pruned_5_new/RR_algoname1000.csv", ignore_index=True)
print("done with merging")
pickle_out = open("results/steam/all_algo_sample_user/RR_algoname1000.pickle","wb")
...
## saving result
#pickle_out = open("results/steam/all_algo_sample_user/recs1000.pickle","wb")
